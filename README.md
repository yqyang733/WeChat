...
* [swissparam生成小分子力场参数的命令行使用](https://mp.weixin.qq.com/s/OoPl-RzTepEP1PqiTLVwzg) | [github](./NoteBook/swissparam生成小分子力场参数的命令行使用.md) | [知乎](https://zhuanlan.zhihu.com/p/27031067970) |     
...
* [gmx后处理|单链体系周期性边界条件处理生成平滑轨迹](https://mp.weixin.qq.com/s/ng68myzJSfyRF7ITaFQb3Q) | [github](./NoteBook/gmx后处理单链体系周期性边界条件处理生成平滑轨迹.md) | [知乎](https://zhuanlan.zhihu.com/p/19438071581) |   
...
* [Gromacs进行拉伸分子动力学（SMD）模拟]() | [github](./NoteBook/Gromacs进行拉伸分子动力学SMD模拟.md) | [知乎]() |  
...
* [Python绘图|Python绘制组合图（双组分柱状分布图+双组分折线图+2个子图）](https://mp.weixin.qq.com/s/knZe5gklszcCnz1GVaAFRA) | [github](./NoteBook/Python绘图Python绘制组合图双组分柱状分布图双组分折线图2个子图.md) | [知乎](https://zhuanlan.zhihu.com/p/28105022124) |    
...
* [博士学位论文写作]() | [github](./NoteBook/博士学位论文写作.md) | [知乎]() |  
...
### 与我联系
### 总结&反思
* [亿笔记公众号文章2024年度总结](https://mp.weixin.qq.com/s/f_bF-9_kbkyfCy8DZmPYjA) | [github](./NoteBook/亿笔记公众号文章2024年度总结.md) | [知乎](https://zhuanlan.zhihu.com/p/20597614642) |   
